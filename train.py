...
from trainer import train_syndiff
...
# nohup python train.py --image_size 256 --exp exp_syndiff --num_channels 2 --num_channels_dae 32 --ch_mult 1 1 2 2 4 4 --num_timesteps 4 --num_res_blocks 1 --batch_size 1 --contrast1 CT --contrast2 T1 --num_epoch 2000 --ngf 32 --embedding_type positional --use_ema --ema_decay 0.999 --r1_gamma 1. --z_emb_dim 256 --lr_d 1e-5 --lr_g 1.6e-4 --lazy_reg 10 --num_process_per_node 1 --save_content --local_rank 0 --input_path ../datasets/new_brain/train --output_path ./output_brain/for/results_minmax0525_cross --port_num 5004 > brain_cross_minmax0525.log 2>&1 &
